...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // 2. Simpan data VRF
        $sql_vrf = "INSERT INTO vrf (tgl_kunjungan, waktu_kunjungan, durasi_kunjungan, gelar_pemohon, nama_pemohon, posisi_pemohon, institusi_pemohon, website_pemohon, email_pemohon, telepon_pemohon, faks_pemohon, deskripsi_institusi, tujuan_kunjungan, bidang_pembahasan, interpreter, status, id_user)
        VALUES ('$visit_date', '$visit_time', '$visit_duration', '$request_person_title', CONCAT('$request_person_first_name', ' ', '$request_person_last_name'), '$request_person_position', '$request_person_institution', '$request_person_website', '$request_person_email', '$request_person_phone', '$request_person_fax', '$institution_overview', '$visit_purpose', '$discussion_topics', '$interpreter', '$status', '$id_user')";
        ...
        // 3. Simpan orang_ditemui jika ada
        ...
        // 4. Simpan kontak_undana jika ada
        ...
        // 7. Commit transaksi jika tidak ada error
        mysqli_commit($conn);
